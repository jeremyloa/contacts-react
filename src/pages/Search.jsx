...
const navigation = [
  ...
  { name: 'Search', href: '/app/search', current: true },
                ...
                <div className="bg-white lg:min-w-0 lg:flex-1">
                    <div className="bg-white shadow sm:rounded-lg">
                        ...
                        <div className="pl-4 pr-6 pt-4 pb-4 border-b border-t border-gray-200 sm:pl-6 lg:pl-8 xl:pl-6 xl:pt-6 xl:border-t-0">
                            ...
                            <h1 className="flex-1 text-lg font-medium">Search Users</h1>
                            </div>
                        ...
                        <ul className="relative z-0 divide-y divide-gray-200 border-b border-gray-200">
                            {api && api.map((use) => ( use.first_name && use.last_name && search && (use.first_name.toLowerCase().includes(search.toLowerCase()) || use.last_name.toLowerCase().includes(search.toLowerCase())) &&
                            <li
                                key={use.id}
