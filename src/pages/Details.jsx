...
const navigation = [
  ...
  { name: 'Favorites', href: '/app/favorites', current: false }
]
            ...
            <div className="flex-1 min-w-0 bg-white xl:flex">
                ...
                <div className="bg-white lg:min-w-0 lg:flex-1">
                        <div className="pl-4 pr-6 pt-4 pb-4 border-b border-t border-gray-200 sm:pl-6 lg:pl-8 xl:pl-6 xl:pt-6 xl:border-t-0">
                            ...
                            <h1 className="flex-1 text-lg font-medium">Details</h1>
                            </div>
                        </div>
                        <ul className="grid grid-cols-1 gap-0 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1">
                            {api && api.map((use) => ( 
                            <li
                            key={use.id}
                            ...
                            >
                                ...
                                <img className="w-32 h-32 flex-shrink-0 mx-auto bg-black rounded-full" src={use.avatar} alt="" />
                                <h2 className="mt-6 text-gray-900 text-sm font-medium">{use.first_name}{' '}{use.last_name}</h2>
                                <div>
                                    <div className="-mt-px flex divide-x">
                                    <div className="w-0 flex-1 flex">
                                        <a
                                        href={`mailto:${use.email}`}
                                        className="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500"
                                        >
                                        <MailIcon className="w-5 h-5 text-gray-400" aria-hidden="true" />
                                        <span className="ml-3">{use.email}</span>
                                        </a>
                                    </div>
                                    </div>
                                    </div>
                                {fav && Array.isArray(fav) && fav.includes(use.id) &&
                                <div>
                                    <button
